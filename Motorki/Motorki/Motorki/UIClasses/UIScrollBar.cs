...
namespace Motorki.UIClasses
{
    ...
    public class UIScrollBar : UIControl
    {
        ...
        public UIScrollBar(Game game, bool vertical = true)
            : base(game)
        {
        ...
        private class UIScrollBarButton : UIControl
        {
            ...
            public UIScrollBarButton(Game game, UIScrollBar parent, bool plusButton)
                : base(game)
            {
        ...
        private class UIScrollBarThumb : UIControl
        {
            ...
            public UIScrollBarThumb(Game game, UIScrollBar parent)
                : base(game)
            {
