...
namespace Motorki
{
    ...
    public class GameSettings
    {
        ...
        public static string gameMapFile { get; private set; }
        public static string gameMapName { get; private set; }
        ...
        public static Color team1Color { get; set; }
        public static Motorek[] team1MotorsTable { get; set; }

        //team 2 settings (team 2 is used only in Team??? game modes; otherwise only team2MotorsTable is used to store other players info)
        public static string team2Name { get; set; }
        public static Color team2Color { get; set; }
        public static Motorek[] team2MotorsTable { get; set; }

        //options: player 1
        public static string player1Name { get; set; }
        public static Keys[] player1Keys { get; set; }
        public static int player1Steering { get; set; } //0 - relative, 1 - absolutive
        public static Color player1Color { get; set; }

        //options: player 2
        public static string player2Name { get; set; }
        public static Keys[] player2Keys { get; set; }
        public static int player2Steering { get; set; } //0 - relative, 1 - absolutive
        ...
        public GameSettings()
        {
            ...
            team1MotorsTable = new Motorek[5];
            team2MotorsTable = new Motorek[5];
            for (int i = 0; i < 5; i++)
            {
                team1MotorsTable[i] = null;
                team2MotorsTable[i] = null;
            }
            ...
            player1Steering = 0; //relative
            player2Steering = 0; //relative
        ...
        public void SaveToFile(string filename)
        {
            ...
            //team1
            XElement team1 = new XElement("team1");
            team1.Add(new XElement("name", team1Name));
            team1.Add(new XElement("color", new XAttribute("r", team1Color.R), new XAttribute("g", team1Color.G), new XAttribute("b", team1Color.B)));
            root.Add(team1);

            //team2
            XElement team2 = new XElement("team2");
            team2.Add(new XElement("name", team2Name));
            team2.Add(new XElement("color", new XAttribute("r", team2Color.R), new XAttribute("g", team2Color.G), new XAttribute("b", team2Color.B)));
            root.Add(team2);
        ...
        public void LoadFromFile(string filename)
        {
            if (File.Exists(filename))
            {
                try
                {
                    ...
                    player1Steering = int.Parse(player1.Element("steering").Value);
                    ...
                    player2Steering = int.Parse(player2.Element("steering").Value);

                    //team1
                    XElement team1 = root.Element("team1");
                    team1Name = team1.Element("name").Value;
                    team1Color = new Color(int.Parse(team1.Element("color").Attribute("r").Value), int.Parse(team1.Element("color").Attribute("g").Value), int.Parse(team1.Element("color").Attribute("b").Value));

                    //team2
                    XElement team2 = root.Element("team2");
                    team2Name = team2.Element("name").Value;
                    team2Color = new Color(int.Parse(team2.Element("color").Attribute("r").Value), int.Parse(team2.Element("color").Attribute("g").Value), int.Parse(team2.Element("color").Attribute("b").Value));
        ...
        public static void SelectMap(string gameMapName)
        {
