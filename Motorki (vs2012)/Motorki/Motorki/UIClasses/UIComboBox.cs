...
namespace Motorki.UIClasses
{
    ...
    public class UIComboBox : UIControl
    {
        ...
        public IList<UITaggedValue> Values { get { return list; } }
        ...
        {
            get { return ((SelectedIndex > -1) && (SelectedIndex < Values.Count) ? Values[SelectedIndex].Text : (Edible ? Text : null)); }
            set
            {
                if (Edible)
                    Text = value;
        ...
        public UITaggedValue SelectedItem
        {
            get { return ((SelectedIndex > -1) && (SelectedIndex < Values.Count) ? Values[SelectedIndex] : (Edible ? new UITaggedValue(Text) : null)); }
            set
            {
                if (Edible)
                    Text = value.Text;
        ...
        public UIComboBox(MotorkiGame game)
            : base(game)
        {
        ...
        private class UIComboButton : UIControl
        {
            ...
            public UIComboButton(MotorkiGame game, UIComboBox parent)
                : base(game)
            {
        ...
        private class UIComboTextBox : UIControl
        {
            ...
            public UIComboTextBox(MotorkiGame game, UIComboBox parent)
                : base(game)
            {
        ...
        public class UIComboListBox : UIControl, IList<UITaggedValue>
        {
            private UIComboBox Parent;
            public bool ClickedOutside { get; set; } //if true then click occured outside of this control

            private List<UITaggedValue> Values; //potrzeba eventu reagujacego na zmiane listy wartosci...
            private int selectedIndex;
            public int SelectedIndex
            {
                get { return selectedIndex; }
            ...
            public string SelectedValue
            {
                get { return ((SelectedIndex >= 0) && (SelectedIndex < Values.Count) ? Values[SelectedIndex].Text : null); }
            ...
            public Rectangle NormalTexture = new Rectangle(0, 0, 37, 30);
            public Rectangle ItemHiliteTexture = new Rectangle(0, 36, 37, 20);
            public Rectangle DisabledTexture = new Rectangle(0, 62, 37, 30);
            ...
            public Rectangle[] Edges = new Rectangle[] { new Rectangle(5, 0, 27, 5),
                                                        ...
                                                        new Rectangle(5, 25, 27, 5) };
            public Rectangle[] ItemHiliteEdges = new Rectangle[] { new Rectangle(0, 0, 5, 20), new Rectangle(32, 0, 5, 20) };
            public Rectangle Middle = new Rectangle(5, 5, 27, 20);
            public Rectangle ItemHiliteMiddle = new Rectangle(5, 0, 27, 20);

            private UIListScrollBar scroll;

            public UIComboListBox(MotorkiGame game, UIComboBox parent)
                : base(game)
            {
                ...
                if (Visible)
                {
                    ...
                    if (Values.Count > 0)
                    {
                        ...
                        for (int i = FirstVisibleIndex; (i < FirstVisibleIndex + MaxVisibleValues) && (i < Values.Count); i++)
                            DrawString(ref UIDrawRequests, vpText, Font, Values[i].Text, new Vector2(0, (i - FirstVisibleIndex) * textHeight), fontColor);
                    }
            ...
            public int IndexOf(UITaggedValue item)
            {
            ...
            public void Insert(int index, UITaggedValue item)
            {
                int oldCount = Values.Count;
                Values.Insert(index, item);
                if (oldCount != Values.Count)
            ...
            public UITaggedValue this[int index]
            {
            ...
            public void Add(UITaggedValue item)
            {
                Values.Add(item);
                MaxVisibleValues = Values.Count; //recalculate scrollbar etc.
            }
            ...
            public bool Contains(UITaggedValue item)
            {
                return Values.Contains(item);
            }

            public void CopyTo(UITaggedValue[] array, int arrayIndex)
            {
            ...
            public bool Remove(UITaggedValue item)
            {
                int oldCount = Values.Count;
                bool ret = Values.Remove(item);
                if (oldCount != Values.Count)
            ...
            public IEnumerator<UITaggedValue> GetEnumerator()
            {
            ...
            private class UIListScrollBar : UIControl
            {
                ...
                public UIListScrollBar(MotorkiGame game, bool vertical = true)
                    : base(game)
                {
                ...
                private class UIListScrollBarButton : UIControl
                {
                    ...
                    public UIListScrollBarButton(MotorkiGame game, UIListScrollBar parent, bool plusButton)
                        : base(game)
                    {
                ...
                private class UIListScrollBarThumb : UIControl
                {
                    ...
                    public UIListScrollBarThumb(MotorkiGame game, UIListScrollBar parent)
                        : base(game)
                    {
